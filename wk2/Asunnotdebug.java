...
public class Asunnotdebug {
  public static void main(String[] args) {
    ...
    System.out.println(hakijat);
    System.out.println("-----------------------");


    TreeSet<Asunto> tarjottavat = new TreeSet<Asunto>(new kokoComp());

    System.out.println(hakijat.size());
    System.out.println(asunnot.size());
    ...
    while (true) {
      ...
      System.out.println("kierros " + i + " hakija " + h);
      if(h == null) {
        break;
      }
      while(true) {
        ...
        if(mahd.getH() <= h.getHtoive()) {
          System.out.println("mahdollinen kämppä hinnan puolesta: " + mahd);
      ...
      System.out.println("tarjottaat" +  tarjottavat);
      if(tarjottava == null) {
        continue;
      }
      //System.out.println("tarjottava: " + tarjottava);
      if(tarjottava.getK() >= h.getKt()) {
        annetut++;
        System.out.println(tarjottava);
